                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="frmsislatpin.php" method="post" style="display:inline; ">
                                            <input type="hidden" name="no_regis" value="<?= $row['no_regis']; ?>">
                                            <input type="hidden" name="nama_siswa" value="<?= $row['Nama Siswa']; ?>">
                                            <input type="hidden" name="nama_tarian" value="<?= $row['Nama Tarian']; ?>">
                                            <input type="hidden" name="metode_latihan" value="<?= $metodeLatihan; ?>">
                                            <input type="hidden" name="kelas" value="<?= $row['kelas']; ?>">
                                            <button class="btn py-0" name="btnPindahPeriode"><i class="fas fa-edit"></i> Pindah Periode</button>
                                        </form>
                                    </td>
                                </tr>
                    <?php
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-item-center justify-content-between small">
                        <div class="text-muted">&copy;2024 Arif & Danas.unigamalang</div>
                    </div>
                </div>
            </footer>
        </div>
